---
title: pushoo.js 让twikoo推送消息到指定app
...
### 💬 [Qmsg](https://qmsg.zendee.cn/) 缩写: `qmsg`
...
### 💬 [Server 酱](https://sct.ftqq.com/r/13235) 缩写: `serverchan`
...
### 💬 [Push Plus](https://www.pushplus.plus/) 缩写: `pushplus`
...
### 💬 [Push Plus Hxtrip](https://pushplus.hxtrip.com/) 缩写: `pushplushxtrip`
...
### 💬 [钉钉](https://open.dingtalk.com/document/group/custom-robot-access) 缩写: `dingtalk`
...
### 💬 [Bark](https://github.com/Finb/Bark) 缩写: `bark`

Bark 是 iOS 通知中心推送工具，可以推送消息到苹果手机上，免费。

1. 下载 [Bark APP](https://apps.apple.com/cn/app/bark-给你的手机发推送/id1403753865)
...
### 💬 [go-cqhttp](https://docs.go-cqhttp.org/api/) 缩写: `gocqhttp`
...
### 💬 [atri](https://github.com/TIANLI0/push-bot-api/) 缩写: `atri`
...
### 💬 [PushDeer](https://www.pushdeer.com/) 缩写: `pushdeer`
...
### 💬 [iGot](https://push.hellyw.com/) 缩写: `igot`
...
### 💬 [Telegram](https://core.telegram.org/bots) 缩写: `telegram`
...
### 💬 [飞书](https://www.feishu.cn/hc/zh-CN/articles/360024984973) 缩写: `feishu`
...
### 💬 [IFTTT](https://ifttt.com/maker_webhooks) 缩写: `ifttt`
...
### 💬 [WECOMBOT](https://developer.work.weixin.qq.com/document/path/91770) 缩写: `wecombot`
...
### 💬 [Discord](https://discord.com/developers/docs/resources/webhook#execute-webhook) 缩写: `discord`
...
### 💬 [WxPusher](https://wxpusher.zjiecode.com/docs/) 缩写: `wxpusher`
...
### 💬 [Join](https://joaoapps.com/join/) 缩写: `join`
